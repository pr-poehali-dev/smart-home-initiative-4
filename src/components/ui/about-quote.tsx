        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              В EduMind AI мы верим, что качественное образование должно быть доступно каждому — независимо от возраста, уровня знаний и предмета. Наш AI-репетитор объясняет сложное простыми словами и адаптируется под темп каждого ученика.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Школьник, готовящийся к экзамену, студент, разбирающийся с курсовой, или взрослый, осваивающий новую профессию — EduMind AI станет вашим личным репетитором 24/7.
            </p>
          </div>
        </div>
      </div>
